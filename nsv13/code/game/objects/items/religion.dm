...
/obj/item/banner/solgov
	...
	desc = "the banner of the Government of Sol, the most powerful member of the Galactic Federation"
	icon = 'nsv13/icons/obj/banners.dmi'
...
/obj/item/banner/draconic
	name = "Banner of the Draconic Empire"
	desc = "the banner of the Draconic Empire, main body and governmental force of the lizardfolk homeworld and its moons"
	icon = 'nsv13/icons/obj/banners.dmi'
...
/obj/item/banner/syndicate
	...
	warcry = "Nanotrasen and SolGov will fall!"
